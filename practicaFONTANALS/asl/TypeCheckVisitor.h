...
public:
  ...
  antlrcpp::Any visitWhileLoop(AslParser::WhileLoopContext *ctx);
  antlrcpp::Any visitInvocation(AslParser::InvocationContext *ctx);
  ...
  antlrcpp::Any visitExprSubscript(AslParser::ExprSubscriptContext *ctx);
  antlrcpp::Any visitExprCall(AslParser::ExprCallContext *ctx);
  ...
  antlrcpp::Any visitSubscript(AslParser::SubscriptContext *ctx);
  antlrcpp::Any visitValue(AslParser::ValueContext *ctx);
  antlrcpp::Any visitIdent(AslParser::IdentContext *ctx);

private:

  void copyDecor(antlr4::ParserRuleContext *dst, antlr4::ParserRuleContext *src);
