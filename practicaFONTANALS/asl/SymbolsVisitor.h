...
public:
  ...
  antlrcpp::Any visitTypePrimitive(AslParser::TypePrimitiveContext *ctx);
  antlrcpp::Any visitTypeArray(AslParser::TypeArrayContext *ctx);
  antlrcpp::Any visitPrimitive(AslParser::PrimitiveContext *ctx);
...
private:
  ...
  void addVariable(antlr4::tree::TerminalNode* ID, TypesMgr::TypeId t);
